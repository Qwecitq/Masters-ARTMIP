...
#data paths 
clim_data_path = ['/global/pscratch/sd/k/kquagra/era5_IVT/']#,
...
for px,pts in enumerate(clim_data_path):
    ...
    if 0<px <=2 or 3<px<=5: 
        for yy in range(1980,2018): #loop through the files year by year 
            ...
            cds = ds.sel(longitude=slice(-170,-60),latitude=slice(55,10))
...
non_con_paths = []
flds =['cascasde_bard_v1','guan_waliser','reid250','mundhenk']
